              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child:
                        const Text("Send to", style: TextStyle(fontSize: 18)),
                  ),
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Row(children: [
                    Text("Enter Your Amount", style: TextStyle(fontSize: 15)),
                    const Spacer(),
                    Text("Change Currency?", style: TextStyle(fontSize: 15, color: Colors.red)),
                  ],),
                ),
                SizedBox(height: 10,),
                Expanded(
                  child: Row(children: [
                    Container(
                      ...
                      child: Text("USD", style: TextStyle(fontSize: 35, color: const Color.fromARGB(255, 152, 190, 255)))),
                    SizedBox(width: 10,),
