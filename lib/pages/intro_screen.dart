      ...
      child: Column(
        children: [
                  ...
                  children: [
                    Container(
                      margin: const EdgeInsets.only(
                          top: 50),
                      height: 300,
                      child: Image.asset(introModel[index].linkGambar),
                    ),
                    Padding(
              ...
              children: List.generate(
                ...
                (index) => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: (indexNow == index) ? Colors.blue : Colors.grey,
                  ),
                ),
              ),
            ),
          ...
          InkWell(
            ...
            child: Container(
              margin: const EdgeInsets.fromLTRB(40, 30, 40, 50),
              height: 70,
              width: 500,
              decoration: BoxDecoration(
